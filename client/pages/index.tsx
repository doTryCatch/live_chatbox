        ...
        <div className="bg-slate-900 p-6 rounded-lg shadow-md space-y-4">
          <div className="  center  space-x-1">
            <div className="head w-[100px]   center">
              <label htmlFor="" className="block text-white font-bold ">
                Room ID:
              </label>
            </div>
            ...
            <div className="input   ">
              <input
                ...
                id="room-id"
                onChange={set_room}
                className="text-slate-200 w-full px-3 py-2 border-b bg-transparent border-gray-300 focus:outline-none focus:border-blue-500"
          ...
          <div className="center space-x-1">
            ...
            <div className="input ">
              <input
                ...
                id="room-id"
                onChange={set_name}
                className="w-full px-3 py-2 border-b bg-transparent border-gray-300 focus:outline-none focus:border-blue-500"
